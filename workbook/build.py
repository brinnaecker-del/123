...
BASE = [
 ...
 ("发电量（规上工业主要产品产量）","亿千瓦时",[46.34,50.24,61.26,70.87,69.12,84.32,114.75,137.38,144.11,162.08]),
...
txt = [
 ...
 ("", False),
 ("复算状态", True),
 ("  安全 US、发展 UD、生态 UE 三个子系统与 MPI 协调指数，均与论文表3 逐年吻合。", False),
 ("  三阶段短板归属（论文核心结论）：10/10 与论文一致。", False),
 ("", False),
 ("D5 发电量口径说明（重要）", True),
 ("  表1 载 D5 为「发电量」、来源「统计公报（规上工业主要产品产量）」。旧版计算文件误填为", False),
 ("  「清洁能源发电量」，两者口径不同，是此前 UD 对不上的全部原因。现已改用规上工业口径。", False),
 ("  其中 2016、2017、2020、2021、2023、2024 六年取自统计公报（橙色以外单元格）；", False),
 ("  2018、2019、2022、2025 四年未检索到公报原值，暂以反解值填入并标为橙色，请以公报原值替换。", False),
 ("  六个公报年份代入后，UD 与 MPI 各 6/6 精确吻合，反证口径判断正确。", False),
 ("", False),
